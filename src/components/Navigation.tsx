...
// Generated: 2025-08-28T09:41:55.673Z
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                <span className="text-background font-bold text-sm">MSR</span>
              </div>
              <span className="font-bold text-xl text-foreground">Master's Sole Revival</span>
            </Link>
          </div>
            ...
            <div className="ml-10 flex items-baseline space-x-8">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-muted-foreground hover:text-primary px-3 py-2 text-sm font-medium transition-colors duration-200 hover:bg-accent/10 rounded-md"
                >
                  {item.name}
                </Link>
              ))}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border-muted">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="text-muted-foreground hover:text-primary block px-3 py-2 text-base font-medium transition-colors duration-200 hover:bg-accent/10 rounded-md"
