        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Expert cobbler services combining traditional craftsmanship with modern techniques. We breathe new life into your finest footwear with meticulous attention to detail.
            </p>
            ...
            <ul className="mt-6 grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
              {[
                ...
                "Same-day heel repairs",
                "Custom sole replacements",
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <Play className="mr-2 size-5" /> View Our Work
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Master cobbler restoring premium leather shoes"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">100%</span> Guaranteed
              </p>
            </div>
          </div>
        </div>
